---
title: "TNSLab - Publications"
layout: gridlay
excerpt: "TNSLab -- Publications."
sitemap: false
...
### 2022
- **컨테이너 이미지 보안성 분석에 관한 연구: Docker Hub 이미지를 중심으로** <br />
  *유명성, 김재한, 신승원* <br />
  한국통신학회논문지, 제47권, 제8호, pp. 1231-1243, 2022 <br />
  [PDF]({{ site.url }}{{ site.baseurl }}/papers/container_security_kics2022.pdf)

- **BPFast: 클라우드 환경을 위한 eBPF/XDP 기반 고속 네트워크 패킷 페이로드 검사 시스템** <br />
  *유명성, 김진우, 신승원, 박태준* <br />
  정보보호학회논문지, 제32권, 제2호, pp. 213-225, 2022 <br />
  [PDF]({{ site.url }}{{ site.baseurl }}/papers/bpfast_kiisc2022.pdf)
...
### 2025
- **High-speed network packet payload inspection system based on eBPF (extended Berkeley Packet Filter)/XDP (express data path) for container environment** <br />
  *Seung Won Shin, Myoung Sung You, Sang Duk Suh, Chang Hoon Yoon, Yeon Keun Kim* <br />
  US Patent 12,244,565, March 2025 <br />

- **Hardware-based reliable and secure container network** <br />
  *Seung Won Shin, Myoung Sung You, Sang Duk Suh, Chang Hoon Yoon, Seung Hyeon Lee* <br />
  US Patent 12,192,172, January 2025 <br />
...
### 2022
- **하드웨어 기반의 신뢰할 수 있는 안전한 컨테이너 네트워크** <br />
  *이승현, 윤창훈, 서상덕, 유명성, 신승원 외* <br />
  KO Patent, 2022 <br />
